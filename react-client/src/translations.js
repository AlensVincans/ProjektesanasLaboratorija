export const translations = {
  lv: {
    ...
    recipes: {
      ...
      clickToGenerate: "Noklikšķiniet uz 'Ģenerēt uztura plānu', lai saņemtu personalizētas receptes, pamatojoties uz jūsu optimizēto uzturu.",
      ingredients: "Sastāvdaļas",
      preparation: "Gatavošana",
  ...
  en: {
    ...
    recipes: {
      ...
      clickToGenerate: "Click 'Generate Meal Plan' to get personalized recipes based on your optimized diet.",
